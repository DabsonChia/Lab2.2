...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String PROFILE_NAME="jdebjksedb";
    public static final String PROFILE_EMAIL="jdhbdhsgvb";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==REQUEST_PROFILE_UPDATE && resultCode==RESULT_OK){
            ...
            textViewName.setText(getString(R.string.txtName)+name);
            textViewEmail.setText(getString(R.string.txtEmail)+email);
        }
    }
